...
export class ModernUIRenderer {
        ...
        <div class="connection-prompt-card glass-effect hover-lift">
          ...
          <div class="prompt-features-grid">
            ...
            <div class="feature-item" title="Docker 管理">
              <div class="feature-icon">${Data({ theme: 'filled', size: '20', fill: '#06b6d4' })}</div>
              <span>Docker</span>
            </div>
        ...
        <div class="panel-card" style="padding:16px; display:flex; justify-content:space-between; align-items:center; gap:12px;">
          ...
          <div style="display:flex; gap:8px; align-items:center;">
            ...
            <select id="ai-chat-model-select" onchange="window.switchAIChatModel && window.switchAIChatModel(this.value)" style="
              ...
              font-size: 12px;
            "></select>
            <button class="modern-btn secondary" onclick="window.openAISettingsFromChat && window.openAISettingsFromChat()">AI设置</button>
            <button class="modern-btn secondary" onclick="window.clearAIChatMessages()">清空对话</button>
          </div>
        </div>
      ...
      ">
        ...
        ">
          ...
          <div class="settings-tabs" style="
            ...
            border-bottom: 1px solid var(--border-color);
          ">
            <button class="settings-tab active" data-tab="basic" onclick="window.switchSettingsTab && window.switchSettingsTab('basic')" style="
              ...
              transition: all 0.2s;
            ">基础设置</button>
            <button class="settings-tab" data-tab="ai" onclick="window.switchSettingsTab && window.switchSettingsTab('ai')" style="
              padding: var(--spacing-md) var(--spacing-lg);
              background: none;
              border: none;
              color: var(--text-secondary);
  ...
  private renderPayloaderPage(): string {
    return `
      <div class="payloader-page" style="
        width: 100%;
        height: 100%;
        display: flex;
        flex-direction: column;
